...
base_dir = "d:/RAG-production-pipeline/enterprise-rag-platform"
...
files_content = {
    "MISSION.md": """# Enterprise RAG Platform Mission
...
""",
    "ROADMAP.md": """# Enterprise RAG Platform Roadmap
...
""",
    "ANTIGRAVITY.md": """# AntiGravity Instructions (Master Prompt)
...
""",
    "AGENTS/infra-agent.md": """# Infra & DevOps Agent
...
""",
    "AGENTS/observability-agent.md": """# Observability Agent
...
""",
    "AGENTS/frontend-agent.md": """# Frontend Agent
...
""",
    "SKILLS/fastapi-patterns.md": """# FastAPI Skills & Patterns
...
""",
    "SKILLS/langgraph-patterns.md": """# LangGraph Skills & Patterns
...
""",
    "SKILLS/hybrid-retrieval.md": """# Hybrid Retrieval Skill
...
""",
    "SKILLS/redis-semantic-cache.md": """# Redis Semantic Cache Skill
...
""",
    "SKILLS/parent-child-retrieval.md": """# Parent-Child Retrieval Skill
...
""",
    "SKILLS/cohere-reranking.md": """# Cohere Reranking Skill
...
""",
    "SKILLS/observability-patterns.md": """# Observability Skills & Patterns
...
""",
    "TASKS/phase-1-foundation.md": """# Phase 1: Foundation
...
""",
    "TASKS/phase-2-ingestion.md": """# Phase 2: Ingestion & Queues
...
""",
    "WORKFLOWS/implementation-workflow.md": """# Implementation Workflow
...
""",
    "CHECKLISTS/production-readiness.md": """# Production Readiness Checklist
...
""",
    "MEMORY/architecture-decisions.md": """# Architecture Decision Records (ADRs)
...
print(f"Successfully generated full Enterprise RAG project structure in {base_dir}")
